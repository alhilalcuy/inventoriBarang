...
#content::after{
 ...
 footer, .navbar,.container-fluid{
  ...
  .navbar-nav{
    background-image:linear-gradient(to right,rgb(29, 27, 27),rgb(31, 92, 205))
  }
</style>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav  bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index3.php">
        ...
        <div class="sidebar-brand-text mx-2">DIKBUD KABUPATEN TEGAL</div>
      </a>
 ...
 <?php
  ...
  <!--sidebar start-->
    ...
    <li class="d-flex align-items-center justify-content-center">
        <a class="nav-link">
		 <img src="img/dibud.png" class="img-circle" width="100" alt="User"/></a>
        ...
        <div id="collapseData" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=satuanbarang">Satuan Barang</a>
			 <a class="collapse-item" href="?page=supplier">Data Sekolah</a>
      ...
      <div class="sidebar-heading">
        ...
        <div id="collapseLaporan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=laporan_supplier">Laporan Data Sekolah</a>
            <a class="collapse-item" href="?page=laporan_barangmasuk">Laporan Barang Masuk</a>
            <a class="collapse-item" href="?page=laporan_gudang">Laporan Data Gudang</a>
