       ...
       <!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <div class="text-center mb-5 text-white">
    	        <h3 style="color:orange; font-family:'Times New Roman';font-weight:bold; text-shadow:0px 0px 8px black;">Selamat Datang di Inventori Barang</h3>
              <h2 style="color:orange; font-family:'Times New Roman';font-weight:bold; text-shadow:0px 0px 8px black;">Dinas Pendidikan dan Kebudayaan Kabupaten Tegal</h2>
    		      <br></br>
         </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              ...
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                     <a  href="?page=supplier"> <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><h4>Data Sekolah</h4></div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
